...
| `--capture-destination <mode>` | Назначение снимков: `inline` (base64 в выводе JSON), `file`, `stage` или `clipboard`. Применяется к захватам окон и — кроме `clipboard` (код выхода 2) — к захватам экрана. |
