...
Copia `scripts/mark-shot-ocr` dal [repository di DracoPho](https://github.com/tystudio-26020701/mark-shot-community) in una directory locale, ad esempio `%LOCALAPPDATA%\mark-shot\mark-shot-ocr.py`.
