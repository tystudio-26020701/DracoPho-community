...
Copy `scripts/mark-shot-ocr` from the [DracoPho repository](https://github.com/tystudio-26020701/DracoPho-community) to a local directory, for example `%LOCALAPPDATA%\mark-shot\mark-shot-ocr.py`.
