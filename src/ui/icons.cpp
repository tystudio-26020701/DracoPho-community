...
QIcon applicationIcon()
{
    ...
    const QIcon icon(QStringLiteral(":/icons/dracoPho.ico"));
    ...
    // cmake install), fall back to the DracoPho PNG and finally a generated
    // glyph so the tray never shows a blank icon.
