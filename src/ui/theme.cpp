 ...
 * @return 浅色样式表文本。
 */
QString lightRecordingDialogStyleSheet()
{
    return QStringLiteral(
        "QDialog {"
        " background: #F8FAFC;"
        "}"
        "QLabel#recordingDialogTitle {"
        " color: #0F172A;"
        " font-weight: 800;"
        "}"
        "QLabel { color: #334155; }"
        ...
        "}"
        "QComboBox:hover, QLineEdit:hover { border-color: #94A3B8; }"
...
QString recordingDialogStyleSheet(bool dark)
{
    if (!dark) {
        return lightRecordingDialogStyleSheet();
    }
    return QStringLiteral(
        "QDialog {"
        " background: #0F172A;"
        ...
        "}"
        "QComboBox:hover, QLineEdit:hover { border-color: #475569; }"
        "QComboBox:focus, QLineEdit:focus { border-color: #5EEAD4; }"
        "QComboBox:disabled, QLineEdit:disabled {"
        " color: #64748B;"
        " background: #111827;"
        "}"
